        ...
        <div>
          ...
          <div className="flex justify-between">
            ...
            <div className="mb-4 mt-6  flex">
              <Link to={`/edit-student/${student.user_uid}`} className="bg-[#FFB70F] flex text-black px-4 py-2 rounded-md">
                Edit Student
              </Link>
              <button
                onClick={whatsApp}
              ...
              <Link to={`/add-student-course/${student.user_uid}`} className="bg-[#FFB70F] flex  ml-3 text-black px-4 py-2 rounded-md">
                Add Course
              </Link >
              <Link to={`/add-student-delivery/${student.user_uid}`} className="bg-[#FFB70F] flex  ml-3 text-black px-4 py-2 rounded-md">
                Add Delivery
              </Link>
              <Link to={`/add-exam/${student.user_uid}`} className="bg-[#FFB70F] flex  ml-3 text-black px-4 py-2 rounded-md">
                Add Exam
              </Link>
            </div>
          </div>
          <div className="grid grid-cols-1 gap-4">
            <div>
              <Card className="mt-4">
                <CardBody>
                  <div className="grid grid-cols-1 md:grid-cols-3 h-[150px] ">
                    {" "}
                ...
                <div class="container mx-auto p-4">
                  <div class="overflow-x-auto">
                    {studentDelivery.length > 0 ? (
                      <DeliveryTable options={studentDelivery} deliverywhatsApp={deliverywhatsApp} />
                    ) : (
                      <div className="flex justify-center">
                        <h1 className="text-black text-2xl">
                          No Data Available
            ...
            {activeSection === "result" && (
              <div className="p-3 mt-3 bg-white shadow-md rounded-lg">
                ...
                <div class="container mx-auto p-4">
                  <div class="overflow-x-auto">
                    {studentExam.length > 0 ? (
                      <ResultTable options={studentExam} sendresultEmail={sendresultEmail} resultwhatsApp={resultwhatsApp} />
                    ) : (
                      <div className="flex justify-center">
                        <h1 className="text-black text-2xl">
                          No Data Available
